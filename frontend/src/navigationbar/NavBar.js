...
import BankingDashboard from './NavigationBarRoutingComponents/StatisticalData';
          ...
          <Toolbar sx={{ pr: '24px' }}>
            ...
            <IconButton>
              <Badge badgeContent={4} sx={{
                '.MuiBadge-badge': {
                  backgroundColor: defaultTheme.palette.lightBrown.main,
                  color: defaultTheme.palette.white.main,
                }
              }}>
                <NotificationsIcon sx={{ color: defaultTheme.palette.black.main }} />
              </Badge>
            </IconButton>
          </Toolbar>
        </AppBar>
