    ...
    <Box display="flex">
      <Box flex={1}>
          ...
          {creditCards.map((card, index) => (
            <Box key={index} display="flex" flexDirection="column" alignItems="center" justifyContent="center">
              ...
              <Typography variant="h5" style={{ color: theme.palette.darkBrown.main }}>
                ${card.creditLimit} credit remaining on this card
              </Typography>
        ...
        <Box display="flex" justifyContent="center" marginTop={2}>
          <Button
            variant="contained"
            style={{ backgroundColor: theme.palette.darkBrown.main }}
      ...
      {showForm && (
        <Box flex={1} marginLeft={2} marginRight={40}  style={{ maxWidth: '500px' }} position="relative">
          <IconButton
          ...
          <form onSubmit={handleFormSubmit}>
            ...
            <Button type="submit" variant="contained" style={{backgroundColor: theme.palette.darkBrown.main}} fullWidth>
              Submit
            </Button>
          </form>
        </Box>
